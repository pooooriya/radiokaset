...
export const messageValidator = {
  ...
  qaLength: 'سوال شما کوتاه است لطفا بیشتر توضیح دهید.',
...
export const emptyMessage = {
  noPage: 'صفحه‌ای که دنبال آن بودید پیدا نشد!',
  noResult: 'متاسفانه هیچ نتیجه‌ای یافت نشد',
  noSubject: 'موضوع مورد نظر یافت نشد',
  noData: 'داده‌ای موجود نیست',
  noResponse: 'متاسفانه خطای بحرانی رخ داده است',
  noPermission: 'متاسفانه شما به این صفحه دسترسی ندارید ',
};
